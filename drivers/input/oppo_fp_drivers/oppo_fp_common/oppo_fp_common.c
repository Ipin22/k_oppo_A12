...
#define ENGINEER_MENU_FPC_1521   "-1,-1"
...
fp_module_config_t fp_module_config_list[] = {
	{{2, -1, -1},  FP_CHIPONE_7332,    	CHIP_CHIPONE,    ENGINEER_MENU_CHIPONE_7332},
	{{1, -1, -1},  FP_FPC_1521,		CHIP_FPC,  	 ENGINEER_MENU_FPC_1521},
        ...
        if ((fp_module_config_list[i].gpio_id_config_list[0] == fp_id1) &&
            ...
            switch (fp_module_config_list[i].fp_vendor_chip) {
                case FP_FPC_1521:
                    ...
                    strncat(fp_manu, "_1521", FP_ID_SUFFIX_MAX_LENGTH - 1);
